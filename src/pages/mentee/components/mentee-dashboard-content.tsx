...
export function MenteeDashboardContent() {
  ...
  const renderRelationshipSection = (stat: any) => {
    const partner = stat.pair.mentor;
            ...
            <Card className="h-full border-primary/10 shadow-sm hover:border-primary/20 transition-all overflow-hidden flex flex-col">
              ...
              <CardHeader className="text-center pt-8 pb-6 px-6">
                ...
                <div className="flex justify-center mt-4 gap-2">
                    <Badge variant="outline" className="font-bold uppercase text-[9px] tracking-widest px-2 py-0.5 bg-green-50 text-green-700 border-green-200">
                      Your Mentor
                    </Badge>
                    <Badge variant="primary" className="text-[9px] uppercase tracking-widest px-2 py-0.5">
                      {stat.pair.status === 'active' ? 'Active' : 'Secondary'}
                    </Badge>
                </div>
              </CardHeader>
      ...
      {activePairings.length === 0 ? (
        ...
        <div className="mb-4">
          <div className="flex items-center gap-4 mb-8">
            <h2 className="text-xs font-black uppercase tracking-[0.3em] text-gray-400 whitespace-nowrap">Your Mentoring Progress</h2>
